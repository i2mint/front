...
Base classes and conventions for building a [`FrontSpec`](front.types.md#front.types.FrontSpec) from a configuration.
...
* **Return type:**
  [`FrontSpec`](front.types.md#front.types.FrontSpec)
* **Returns:**
