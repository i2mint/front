...
The tree is then walked by [`AppMaker`](front.app_maker.md#front.app_maker.AppMaker) to produce the
...
* **Parameters:**
  ...
  * **rendering_spec** ([`dict`](https://docs.python.org/3/builtins/stdtypes.html#dict)) – The rendering spec of the application, compiled from
    ...
    have in common).
* **Return type:**
  [`FrontContainerBase`](front.elements.elements.md#front.elements.elements.FrontContainerBase)
* **Returns:**
